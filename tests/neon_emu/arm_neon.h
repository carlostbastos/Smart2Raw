 ...
 */
/* arm_neon.h EMULADO - implementa em C portavel SO os intrinsecos usados pela
 * Smart2Raw, com semantica fiel a especificacao ACLE/ARM. Lanes sao modeladas
 * como arrays logicos indexados 0..N-1 (lane 0 = endereco mais baixo no vld1q),
 * portanto independem do endianness do host x86. Permite compilar/EXECUTAR as
 * funcoes NEON reais do header nesta maquina e validar lanes, larguras e cauda.
 *
 * NAO e a SIMDe; e um shim minimo e auditavel para teste. */
...
/* Unsigned Add Long Pairwise: out[i] = a[2i] + a[2i+1], largura dobra. */
