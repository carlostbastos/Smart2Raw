 ...
 *
 * The header functions are `static inline` and do not appear in the symbol table
 * of a shared library; this file exposes them behind a flat
 * API with an opaque S2RPool* pointer.
 *
 ...
 *                  (ou use build_lib.py, que detecta a plataforma)
 */
#include <stdlib.h>
#include "smart2raw.h"
